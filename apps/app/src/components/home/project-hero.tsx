...
interface ProjectHeroProps {
  org?: OrgWithoutWallet | null;
}

export function ProjectHero({ org }: ProjectHeroProps) {
        ...
        <div className='text-center'>
          {org ? (
            <>
              ...
              {org.description && (
                <p className='text-xl text-muted-foreground max-w-3xl mx-auto font-medium drop-shadow-md'>
                  {org.description}
                </p>
              )}
            </>
            ...
            <>
              <div className='mb-8'>
                ...
                <p className='text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed'>
                  Join exclusive raffles, win amazing prizes, and connect with your favorite teams on the Chiliz
                  blockchain
                </p>
              </div>
